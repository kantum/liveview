defmodule Liveview.ShoppingCart do
  @moduledoc """
  ...
  alias Liveview.ShoppingCart.{Cart, CartItem}
  ...
  def update_cart(%Cart{} = cart, attrs) do
    ...
    |> case do
      ...
      {:error, :cart, changeset, _change_so_far} -> {:error, changeset}
    end
  end
  ...
  alias Liveview.ShoppingCart.CartItem
