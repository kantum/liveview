defmodule LiveviewWeb.PostControllerTest do
  use LiveviewWeb.ConnCase

  import Liveview.BlogFixtures

  @create_attrs %{body: "some body", title: "some title", word_count: 42}
  @update_attrs %{body: "some updated body", title: "some updated title", word_count: 43}
