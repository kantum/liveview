defmodule Liveview.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Liveview.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Liveview.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Liveview.ShoppingCart.create_cart_item()
